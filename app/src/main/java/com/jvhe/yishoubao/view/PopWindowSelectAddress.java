...
import com.jvhe.yishoubao.model.AddressSelectModel;
import com.jvhe.yishoubao.view.wheel.OnWheelChangedListener;
import com.jvhe.yishoubao.view.wheel.WheelView;
import com.jvhe.yishoubao.view.wheel.adapters.BaseWheelTextAdapter;
 ...
 * 2016年5月19日 15:31:27
 */
public class PopWindowSelectAddress extends PopupWindow implements OnWheelChangedListener {
	...
	public PopWindowSelectAddress(Context context, OnClickListener itemsOnClick) {
		super(context);
		mContext = context;
