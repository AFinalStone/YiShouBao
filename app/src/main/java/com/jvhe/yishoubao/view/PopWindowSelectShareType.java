 ...
 * 2016-12-26 18:32:01
 */
public class PopWindowSelectShareType extends PopupWindow {
	...
	public PopWindowSelectShareType(Context context, OnClickListener itemsOnClick) {
		super(context);
		LayoutInflater inflater = (LayoutInflater) context
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		mMenuView = inflater.inflate(R.layout.pop_my_shop_select_share_type, null);
		...
		mMenuView.setOnTouchListener(new OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				int height = mMenuView.findViewById(R.id.linearLayout_bottom).getTop();
