 ...
 */
public class RecyclerViewHeaderAndFooterAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerViewHeaderAndFooterAdapter() {
    }

    public RecyclerViewHeaderAndFooterAdapter(RecyclerView.Adapter innerAdapter) {
