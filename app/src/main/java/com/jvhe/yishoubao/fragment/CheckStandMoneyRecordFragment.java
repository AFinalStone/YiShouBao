...
public class CheckStandMoneyRecordFragment extends MyBaseFragment<CheckStandMoneyRecordActivity> {
    ...
    public class RecycleAdapter extends RecyclerViewBaseAdapter<RecycleAdapter.MyViewHolder, RecordModel> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = View.inflate(mActivity, R.layout.adapter_check_stand_money_record, null);
